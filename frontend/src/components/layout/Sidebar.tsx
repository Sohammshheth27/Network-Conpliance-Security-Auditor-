...
const primaryNav = [
  ...
  { name: 'Findings', to: '/analysis', icon: LayoutGrid },
  { name: 'Assessments', to: '/assessments', icon: CalendarCheck },
  { name: 'New Audit', to: '/new-audit', icon: Server },
  { name: 'Frameworks', to: '/frameworks', icon: FileText },
